...
func (b *LesApiBackend) TransactionByHash(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
	return b.eth.txPool.GetTransaction(txHash), false, nil
}
